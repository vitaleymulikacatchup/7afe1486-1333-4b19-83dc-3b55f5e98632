...
export const metadata: Metadata = {
  title: "RPRT Sports + Talent Management | Elite Career Management",
  description: "Premier sports and talent management agency in Hollywood. Expert career management, contract negotiations, PR, and brand development for elite athletes and entertainers.",
  keywords: "sports management, talent agent, hollywood agent, athlete management, entertainment management, contract negotiation, celebrity PR",
  openGraph: {
    title: "RPRT Sports + Talent Management | Elite Career Management",
    description: "Premier sports and talent management agency in Hollywood. Expert career management, contract negotiations, PR, and brand development for elite athletes and entertainers.",
    ...
    images: [
      {
        url: "https://images.pexels.com/photos/8730043/pexels-photo-8730043.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "RPRT Sports + Talent Management | Elite Career Management",
    description: "Premier sports and talent management agency in Hollywood. Expert career management, contract negotiations, PR, and brand development for elite athletes and entertainers.",
    images: ["https://images.pexels.com/photos/8730043/pexels-photo-8730043.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
